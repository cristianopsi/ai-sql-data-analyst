...
SECRET_MAPPINGS: tuple[SecretMapping, ...] = (
    ...
    SecretMapping("database-url", "DATABASE_URL", required=False),
    SecretMapping("analytics-database-url", "ANALYTICS_DATABASE_URL", required=False),
    SecretMapping("cloud-sql-app-password", "CLOUD_SQL_APP_PASSWORD", required=False),
    SecretMapping("cloud-sql-analytics-password", "CLOUD_SQL_ANALYTICS_PASSWORD", required=False),
)
